...
/*
 * Добавлен multiplier для нивелирования времени загрузки изображения
 */
...
var Ping = function(opt) {
    ...
    this.multiplier = this.opt.multiplier || 1;
};
    ...
    function pingCheck(e) {
        ...
        if (typeof callback === "function") {
            ...
            if (!this.wasSuccess) {
                ...
                console.log(e);
                return callback("error", Math.ceil(pong * self.multiplier));
            }
            return callback(null, Math.ceil(pong * self.multiplier));
        }
    }
